...
class CloudWatchActions:
    def __init__(self, access_key, secret_key, region):
        ...
        self.region = region
        self.cloudwatch_client = Client(access_key, secret_key, region).cloudwatch_client()

    def display_metric_values(self):
        "Displays DiskReadOps and CPUCreditsUsage for an EC2 instance"
        ...
        for metric in metrics:
            ...
            if datapoints:
                ...
                print(f'Average {metric["MetricName"]} over the last 30 minutes: {average_value}')
            else: 
                print(f"No {metric['MetricName']} metric data is available for the {instance_id} instance in the last 30 minutes.")
    ...
    def set_alarm(self):
        ...
        print(f'Alarm "{alarm_name}" set for {metric_name} greater than or equal to {threshold} Bytes.')
